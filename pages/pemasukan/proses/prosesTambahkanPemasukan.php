...
try {
    ...
    $sqlPemasukan = "INSERT INTO pemasukan (user, nama, jumlah, nominal, total, created_at) 
                     VALUES (?, ?, ?, ?, ?, ?)";
    ...
    $catatan = "Pemasukan dari $nama dengan jumlah $jumlah dan nominal $nominal, total: $total";
    ...
    // Set pesan sukses
    $_SESSION['messages'] = 'Penambahan pemasukan telah berhasil.';
